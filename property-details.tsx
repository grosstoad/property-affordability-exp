...
(Math.pow(1 + monthlyRate, termMonths) - 1)
  ...
  const MortgageChoiceLogo = () => (
    <svg width="140" height="28" viewBox="0 0 256 48" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M80.8503 0.838867H84.0327V18.9593H80.6524V6.47764L75.9104 13.2873H75.3404L70.5588 6.47764V18.951H67.2021V0.838867H70.3846L75.6649 8.44581L80.8503 0.838867Z" fill="#006875"/>
      {/* Rest of the SVG paths */}
      <path d="M255.386 13.0298H246.425C246.623 15.3883 247.81 16.4181 249.433 16.4181C250.937 16.4181 252.022 15.6956 252.687 13.8852L255.378 14.9233C254.389 17.9295 252.149 19.2748 249.552 19.2748C245.799 19.2748 243.187 16.4762 243.187 12.2824C243.187 8.13848 245.752 5.32324 249.409 5.32324C252.94 5.32324 255.402 8.12187 255.402 12.2575C255.41 12.49 255.41 12.7973 255.386 13.0298ZM246.52 10.7544H252.172C251.824 8.86097 250.819 8.01391 249.409 8.01391C247.858 8.0056 246.868 8.9191 246.52 10.7544Z" fill="#006875"/>
      <path d="M27.5085 16.9411C27.5085 16.9411 38.5838 0.772197 50.2686 0.772197C54.1635 0.772197 56.7998 2.69885 57.061 5.38951C57.3381 8.15492 55.7944 11.6013 50.5298 11.2359C46.8407 10.9868 34.0001 8.73624 25.8539 24.3737C25.8539 24.3737 25.2998 14.2006 20.2411 8.22135C17.5653 5.05733 17.8424 2.12583 20.5182 0.381884C20.5182 0.381884 25.0148 -2.01812 26.4081 5.21512C27.0414 8.45388 27.9914 13.5529 27.5085 16.9411Z" fill="#5AE2E0"/>
          ...
          <CardContent className="p-5">
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                {/* Standard Loan Details - Always visible */}
                <div className="bg-white rounded-lg p-4 mb-4 border border-gray-200">
                  <div className="text-lg font-medium mb-2">Standard Home Loan</div>
                  
                  <div className="grid grid-cols-3 gap-4">
                    <div>
                      <div className="text-gray-600 text-sm">Variable rate</div>
                      <div className="text-2xl font-semibold">{interestRate}<span className="text-base">% p.a.</span></div>
                    </div>
                    <div>
                      <div className="text-gray-600 text-sm">Comparison rate*</div>
                      <div className="text-2xl font-semibold">{comparisonRate}<span className="text-base">% p.a.</span></div>
                    </div>
                    <div>
                ...
                {calculateLVR() > 80 && (
                  <div className="bg-blue-50 rounded-lg p-4 mb-4">
                    ...
                    <div className="bg-white rounded-lg p-4 mb-3 border border-gray-200">
                      <div className="text-lg font-medium mb-2">Mortgage Choice Freedom Variable Saver 70-80% LVR</div>
